...
namespace AIVisualizer
{
    ...
    public partial class GraphVisualizer : EditorWindow
    {
        ...
        Dictionary<AIObject, string> m_Graphs = new Dictionary<AIObject, string>();
        AIObject m_CurrentGraph = null;

        const float k_ToolbarHeight = 17f;

        [MenuItem("Window/AI Graph Visualizer")]
        public static void ShowWindow()
        {
            EditorWindow.GetWindow<GraphVisualizer>("AI Graph Vis");
        }

        private GraphVisualizer()
        {
            AIGraphVisualizerClient.instance.updateGraph = OnUpdateGraph;
            AIGraphVisualizerClient.instance.removeGraph = RemoveGraph;
        ...
        public void RemoveGraph(AIObject p)
        {
        ...
        public void OnUpdateGraph(AIObject p, string title)
        {
            if (!m_Graphs.ContainsKey(p))
            {
        ...
        public void UpdateLayout(AIObject graph)
        {
            if (m_Layout == null)
        ...
        private void DoToolbar()
        {
            ...
            if (m_Graphs.Count == 1 && m_CurrentGraph != null)
            {
